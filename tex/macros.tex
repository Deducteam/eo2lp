...
\newcommand{\maybe}[1]{\wrapp{eoPunct}{\langle}{\rangle_?}{#1}}
\newcommand{\many}[1]{\wrapp{eoPunct}{\langle}{\rangle_+}{#1}}
\newcommand{\any}[1]{\wrapp{eoPunct}{\langle}{\rangle_∗}{#1}}
\newcommand{\some}[1]{\wrapp{eoPunct}{\langle}{\rangle}{#1}}
...
\newcommand{\eoTermSyntax}{
	\begin{array}[t]{r@{\ }l@{\quad}l@{\qquad}r@{\ }l@{\quad}l}
		...
		ℓ & {⦂}\ \maybe{\ev{-}}n ∣ \maybe{\ev{-}}{n\ev{/}m}  ∣ \estr{s}          & \mcomment{(literals)}        &
