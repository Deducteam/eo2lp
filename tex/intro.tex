...
%
\autoref{sec:lambdapi} defines the translation into
the $λΠ$-calculus modulo rewriting uniformly across
rules, programs, and elaboration;
...
\begin{boxfigure}[t!]{fig:eo-syntax}
	{Eunoia syntax: terms, attributes, commands, proof commands.}
	\alttext{Four stacked grammar tables.
		...
		binder, arg-list).
		Third: standard commands---declare-const, declare-parameterized-const,
		...
		Fourth: proof commands---assume, assume-push, step (with rule, optional
