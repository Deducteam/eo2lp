...
\else
	...
	\definecolor{eoPunct}{HTML}{5a5558}%         punctuation (dark grey)
...
% Springer EU-mandated alt-text for figures (TikZ / complex graphics).
% First argument is a textual description used by Springer's production process.
\providecommand{\alttext}[2]{#2}

% LNCS conventions for autoref names (capitalized).
\AtBeginDocument{%
